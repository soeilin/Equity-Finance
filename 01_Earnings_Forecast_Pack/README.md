...
## Structure  
1. Rent roll aggregation (base rent, renewals, expiries)  
2. Operating expenses & recoveries  
3. NOI → NPI bridge  
4. Interest expense and capital commitments  
5. FFO & AFFO calculations  
6. 3-scenario forecast (Base / Bull / Bear)  
...
• NOI to AFFO bridge: AFFO per unit trend, Dividend coverage
• Scenario-based rent roll
• Sensitivity-driven valuation impact 
• Tornado sensitivity charts.
• Key driver analysis for equity research narrative
